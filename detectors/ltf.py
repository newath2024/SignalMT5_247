from scanner.config.ltf import SIGNAL_AMBIGUITY_DELTA, TIMEFRAME_PRIORITY, WATCH_EXPIRY_BARS, WATCH_INVALIDATION_BUFFER_POINTS
from scanner.ltf.execution import build_signal
from scanner.ltf.sweep import detect_ltf_watch_trigger
from scanner.ltf.trigger import detect_mss_confirmation
...
def _confirm_watch(snapshot, all_htf_zones, watch_setup):
    ...
    signal = build_signal(snapshot, watch_setup["context"], trigger, watch_setup["timeframe"], all_htf_zones)
    if signal is None:
        return None
