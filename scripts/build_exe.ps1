...
$distDir = Join-Path $root "dist\OpenClawScanner"
...
Get-ChildItem -Path $root -Recurse -File -Filter "*.pyc" -ErrorAction SilentlyContinue | Remove-Item -Force -ErrorAction SilentlyContinue
