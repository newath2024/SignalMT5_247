"""Canonical engine-facing reasoning and display helpers."""
...
from domain.scoring import compute_setup_score, format_score, grade_from_score
...
def format_sweep_detail(payload: dict[str, Any] | None) -> str:
    ...
    liquidity_text = ", ".join(str(item) for item in liquidity) if liquidity else "structural liquidity"
...
def build_detail_payload(
    ...
    return {
        ...
        "liquidity_interaction_state": "Structure only",
