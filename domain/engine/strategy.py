"""Canonical strategy runtime wrapper.

Compatibility re-exports remain under ``domain.strategy.engine`` while callers
migrate to ``domain.engine``.
"""
...
from .display import derive_display_state
